...
const testimonials = [
  {
    id: 1,
    quote: "The quality honestly surprised me. The fabric feels premium and the fit is perfect.",
    author: "ALEXANDRA MIRO",
  },
  {
    id: 2,
    quote: "I've ordered twice already. The pieces look even better in person and the delivery was fast.",
    author: "JAMES CARTER",
  },
  {
    id: 3,
    quote: "Minimal design, great materials, and everything fits so well. Easily one of my favorite brands.",
    author: "EMMA WILSON",
  },
  {
    id: 4,
    quote: "You can immediately tell the difference in quality. The stitching and fabric are excellent.",
    author: "DANIEL PARKER",
  },
  {
    id: 5,
    quote: "Every piece feels thoughtfully designed. Comfortable, stylish, and easy to wear every day.",
    author: "SOPHIA MARTINEZ",
  },
  {
    id: 6,
    quote: "I get compliments every time I wear their clothes. Definitely ordering more soon.",
...
export default function TestimonialSwiper() {
  ...
  useEffect(() => {
    ...
    const split = new SplitText(testimonialHeadingRef.current, {
      type: "lines",
      mask: "lines",
      linesClass: "line",
      autoSplit: true,
